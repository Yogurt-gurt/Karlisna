...
//Route::get('/doku-request', function () {
  //  return view('doku-request');
//})->name('doku.form');

// Route untuk mengirim request
//Route::post('/doku-request', [DokuController::class, 'submitRequest'])->name('doku.request');


Route::get('/create-va', function () {
 return view('submit-va');
});

Route::post('/submit-and-create-va', [DokuController::class, 'submitAndCreateVirtualAccount'])->name('submit-and-create-va');
...
Route::post('/create-virtual-account', [VirtualAccountController::class, 'createVirtualAccount'])->name('virtualAccount.create');
// Route untuk membuat virtual account dan melihat responsnya
Route::get('/check-virtual-account-response', [VirtualAccountController::class, 'createVirtualAccount']);
Route::get('/virtual-account/request', [VirtualAccountController::class, 'showRequestPage'])
    ->name('virtualAccount.request');