    ...
    <div class="content-background">
        ...
        <form action="{{ route('createPayment') }}" method="POST">
            ...
            <div class="form-group">
                <input type="hidden" id="nama" name="nama" class="form-control" value="{{ Auth::user()->name }}"
                    readonly required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="hidden" id="jenis_simpanan" name="jenis_simpanan" class="form-control" required
                    value="simpanan_sukarela" readonly>
            </div>
            <div class="form-group">
