            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Welcome Ketua {{ Auth()->user()->role }}</h3>
...
@elseif (auth()->user()->roles == 'ketua') <div class="card-container d-flex">
    <div class="card">
        <h3><i class="fas fa-clipboard-check icon"></i> Manager Dashboard</h3>
        <p>Overview</p>
        <p class="value">Manager-specific data here</p>
    </div>
</div>
@endif
@endsection