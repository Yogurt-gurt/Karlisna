    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Data Anggota</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('approve-ketua') }}">Approvel
                            Registrasi</a></li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{ route('ketua.pinjaman') }}">Approvel Pinjaman
                            Tanpa Angunan</a></li>
                </ul>
            </div>
        </li>
